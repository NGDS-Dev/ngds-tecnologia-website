...
class us_migration_6_0 extends US_Migration_Translator {
	...
	public function translate_theme_options( &$options ) {
		...
		// Reset Product & Shop Page Templates
		...
		// Set new Page Templates for WooCommerce pages
	...
	// Create Reusable Block for Shop & Products
	private function create_shop_template( $is_shop = FALSE ) {
		...
		// Create Reusable Block and return its ID
		ob_start();
