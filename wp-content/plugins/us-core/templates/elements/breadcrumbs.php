...
// Never show the element on the homepage
if ( is_front_page() ) {
	return;
}

// Never show the element inside grid items
...
if ( $delimiter != '' ) {
	$delimiter = '<div class="g-breadcrumbs-separator">' . $delimiter . '</div>';
}
