...
// Check if this element used as shortcode via Live Builder in Page Template / Reusable Block
$is_shortcode_template_preview = ( usb_is_template_preview() AND $us_elm_context == 'shortcode' );
...
if ( $type == 'price' ) {
	...
	// Change the price html tag to be compatible with the Germanized plugin
	$tag = 'p';
...
if ( $value != '' OR usb_is_post_preview() ) {
	echo $output;
}
