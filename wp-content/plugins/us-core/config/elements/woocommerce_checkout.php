...
/**
 * Configuration for shortcode: Checkout
 */
...
if ( us_is_elm_editing_page() ) {
	...
	$_description .= '<br><br>';
	$_description .= sprintf( __( 'To customize the %s page use the following elements instead:' ), us_translate( 'Checkout', 'woocommerce' ) );
	$_description .= '<br><br><strong>';
	$_description .= '&nbsp;&bull;&nbsp;' . us_config( 'elements/checkout_billing.title' ) . '<br>';
	$_description .= '&nbsp;&bull;&nbsp;' . us_config( 'elements/checkout_order_review.title' ) . '<br>';
	$_description .= '&nbsp;&bull;&nbsp;' . us_config( 'elements/checkout_payment.title' ) . '<br>';
...
return array(
	'title' => us_translate( 'Checkout', 'woocommerce' ),
